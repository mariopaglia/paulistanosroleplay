...
local servico = false
local selecionado = 0
local CoordenadaX = -1923.94
local CoordenadaY = 2054.62
local CoordenadaZ = 140.83
...
Citizen.CreateThread(function()
	while true do
		...
		if servico then
			...
			if distance <= 3 then
				-- DrawMarker(25,locs[selecionado].x,locs[selecionado].y,locs[selecionado].z-0.6,0,0,0,0.0,0,0,0.5,0.5,0.4,255,0,0,50,0,0,0,1)
