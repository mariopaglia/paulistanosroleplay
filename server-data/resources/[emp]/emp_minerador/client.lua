	...
	while true do
		...
		if not processo then
			...
			if distancia <= 1.8 then 
				...
				if distancia <= 1.8 then
					drawTxt("PRESSIONE  ~r~E~w~  PARA COMEÇAR A MINERAR",4,0.5,0.93,0.50,255,255,255,180)
		...
		if processo then
			drawTxt("AGUARDE ~r~"..segundos.."~w~ SEGUNDOS ATÉ QUEBRAR A PEDRA",4,0.5,0.93,0.50,255,255,255,180)
		end
	end
end)
