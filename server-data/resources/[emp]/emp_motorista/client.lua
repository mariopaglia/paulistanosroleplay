		...
		if not emservico then
			...
			if distance <= 30.0 then
				...
				if distance <= 1.2 then
					drawTxt("PRESSIONE  ~r~E~w~  PARA INICIAR ROTA",4,0.5,0.93,0.50,255,255,255,180)
		...
		if emservico then
			...
			if distance <= 50 then
				...
				if distance <= 2.5 then
					drawTxt("PRESSIONE  ~r~E~w~  PARA CONTINUAR A ROTA",4,0.5,0.93,0.50,255,255,255,180)
					if IsControlJustPressed(0,38) then
