...
local pegarBlips = {
	...
	{['x'] = -1887.56, ['y'] = 2072.05, ['z'] = 140.99 }, -- -1887.56,2072.05,140.99 (Sinaloa)
}
...
-- CANCELAR
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping('emp:farmbratva_fenix', 'Cancelar Rota Bratva', 'keyboard', 'F7')

RegisterCommand('emp:farmbratva_fenix', function()
	if servico then
			servico = false
			RemoveBlip(blips)
