...
Perm = Tunnel.getInterface("nav_mercado-armas")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	elseif data == "comprar-corpodemtar21" then
		TriggerServerEvent("departamento-comprar","corpodemtar21")
