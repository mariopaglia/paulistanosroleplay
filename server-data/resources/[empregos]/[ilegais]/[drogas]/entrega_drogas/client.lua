...
local locs = {
    ...
    [10] = {['x'] = -602.01, ['y'] = -1115.72, ['z'] = 25.86},
    [11] = {['x'] = -2.85, ['y'] = -1496.52, ['z'] = 31.86},
    [12] = {['x'] = 215.34, ['y'] = -1861.76, ['z'] = 30.87},
    [13] = {['x'] = 559.48, ['y'] = -1776.57, ['z'] = 33.45},
    [14] = {['x'] = 1258.84, ['y'] = -1761.35, ['z'] = 49.66},
    [15] = {['x'] = 858.26, ['y'] = -1038.34, ['z'] = 33.08},
    [16] = {['x'] = 1113.84, ['y'] = -649.13, ['z'] = 57.75},
    [17] = {['x'] = 820.89, ['y'] = -156.47, ['z'] = 80.76},
    [18] = {['x'] = 115.38, ['y'] = 170.38, ['z'] = 112.46},
    [19] = {['x'] = -357.31, ['y'] = 16.36, ['z'] = 47.86},
    [20] = {['x'] = -124.43, ['y'] = -980.02, ['z'] = 27.28},
    [21] = {['x'] = 57.02, ['y'] = -444.84, ['z'] = 37.56},
    [22] = {['x'] = 240.69, ['y'] = -1379.39, ['z'] = 33.75},
    [23] = {['x'] = 267.85, ['y'] = -643.95, ['z'] = 42.02},
    [24] = {['x'] = 64.14, ['y'] = -1040.3, ['z'] = 33.46},
    [25] = {['x'] = 281.17, ['y'] = -992.79, ['z'] = 33.45},
    [26] = {['x'] = 486.39, ['y'] = -591.45, ['z'] = 26.22},
    [27] = {['x'] = 396.4, ['y'] = -355.2, ['z'] = 46.82}, --
    [28] = {['x'] = 135.33, ['y'] = 323.24, ['z'] = 116.64},
    [29] = {['x'] = -818.82, ['y'] = -575.35, ['z'] = 30.28},
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- TRABALHAR
-----------------------------------------------------------------------------------------------------------------------------------------
                ...
                if distance <= 1.2 then
                    ...
                    if IsControlJustPressed(0, 38) and not IsPedInAnyVehicle(ped) then
                        if emP.checkPayment() then
                            ...
                            emP.MarcarOcorrencia(id,x,y,z) -- Acionar a policia
...
-----------------------------------------------------------------------------------------------------------------------------------------
local blip = nil
RegisterNetEvent('blip:criar:traficodrogas')
AddEventHandler('blip:criar:traficodrogas',function(x,y,z)
	if not DoesBlipExist(blip) then
		...
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString("Roubo: Tráfico de Drogas")
...
RegisterNetEvent('blip:remover:traficodrogas')
AddEventHandler('blip:remover:traficodrogas',function()
