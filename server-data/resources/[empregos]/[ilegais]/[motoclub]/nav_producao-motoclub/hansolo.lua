...
oC = Tunnel.getInterface("nav_producao-motoclub")
local nomesnui = "fechar-nui-motoclub"
-------------------------------------------------------------------------------------------------
--[ LOCAL ]--------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
local prodMachine = {
	{ ['x'] = -2613.18, ['y'] = 1687.43, ['z'] = 141.87 }, -- -2613.18,1687.43,141.87 (Midnight)
	{ ['x'] = 815.71, ['y'] = -2313.54, ['z'] = 30.47 }, -- 815.72,-2313.54,30.47 | (DriftKing)
}
-------------------------------------------------------------------------------------------------
--[ MENU ]---------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "produzir-macarico" then
		TriggerServerEvent("produzir-macarico","maçarico")
