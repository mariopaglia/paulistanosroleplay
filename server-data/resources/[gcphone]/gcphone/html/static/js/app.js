webpackJsonp([0], [, , , , , , function (t, e, n) {
  ...
  var a = n(23),
    ...
    f = 365 * l,
    d = {
      fr_FR: ["agora", ["%s segundo atrás", "%s segundos atrás"],
  ...
  e.default = {
    ...
    computed: o()({}, n.i(i.b)(["bankAmont", "IntlString"]), {
      bankAmontFormat: function () {
        return Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL', maximumSignificantDigits: 8 }).format(this.bankAmont)
      }
    }),
    created: function () {
