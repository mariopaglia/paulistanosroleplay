...
emP = Tunnel.getInterface("nav_drogas")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "utilidades-comprar-embalagem" then
		TriggerServerEvent("drogas-comprar","embalagem")
	elseif data == "utilidades-comprar-frasco" then
	...
	elseif data == "utilidades-vender-frasco" then
		TriggerServerEvent("drogas-vender","frasco")
	elseif data == "utilidades-vender-pino" then
		TriggerServerEvent("drogas-vender","pino")
