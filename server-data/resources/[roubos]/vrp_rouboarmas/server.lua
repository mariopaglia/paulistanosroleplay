        ...
        if #policia >= 2 then
            if (os.time() - variavel1) < 1200 then
                ...
                for l, w in pairs(policia) do
                    ...
                    if player then
                        async(function()
                            ...
                            TriggerClientEvent("Notify", player, "policia", "O roubo começou na <b>Ammunation</b>, dirija-se até o local e intercepte o assaltante.", 20000)
                            TriggerClientEvent('chatMessage', player, "CENTRAL:",{65,130,255}, "O roubo começou na ^1Ammunation^0, dirija-se até o local e intercepte o assaltante.")
                ...
                SetTimeout(10000, function()
                    ...
                    vRP.giveInventoryItem(user_id, "ticketpvp", 1) -- Ajuste do pagamento em dinheiro sujo
