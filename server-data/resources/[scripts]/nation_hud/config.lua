...
config = {
    ...
    defaultVoiceMode = 1, -- modo do voip que vai ser iniciado com a hud
...
local avisarDesmaio = function()
    ...
    while true do
        ...
        if health > 101 then
            ...
            -- print("")
            if hunger < 0.2 then
                TriggerEvent("Notify", "aviso", "Você está perdendo vida pois <b>está com fome</b>, coma algo!")
            elseif thirst < 0.2 then
                TriggerEvent("Notify", "aviso", "Você está perdendo vida pois <b>está com sede</b>, tome algo!")
            end
        end
        Citizen.Wait(20000)
    end
...
CreateThread(avisarDesmaio) -- Avisar desmaio
