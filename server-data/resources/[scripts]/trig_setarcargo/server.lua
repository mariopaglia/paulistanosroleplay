...
local webset = "https://discordapp.com/api/webhooks/764596929270513675/ExgFazT7XlZH99PNny5RaWIYpWvaJsRaWNS4xZT7zNSw-Y0mOEu2xRc-tgYcjue-nkva"
                        ...
                        if idc then
                            if vRP.hasGroup(idc,v) then
                                ...
                                if request then
                                    ...
                                    TriggerClientEvent("Notify",source,"sucesso","Você removeu o ID: "..idc.." Ao grupo "..v)
                                ...
                                if vRP.request(sourcec,"Você deseja se ingressar ao grupo "..v.. " ?",15) then
                                    ...
                                    TriggerClientEvent("Notify",source,"sucesso","Você adicionou o ID: "..idc.." Ao grupo "..v)
                            ...
                            TriggerClientEvent("Notify",source,"sucesso","Usuário não esta online")
                        end
                    end
