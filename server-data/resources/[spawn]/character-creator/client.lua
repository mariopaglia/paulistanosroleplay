...
function TriggerCreateCharacter()
	...
	CreateThread(function()
		while continuousFadeOutNetwork do 
			for id = 0,300 do
...
function refreshDefaultCharacter()
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),11,0,0,1)
		...
		SetPedPropIndex(PlayerPedId(),6,-10,0,2)
		...
		SetPedComponentVariation(PlayerPedId(),4,0,0,1)
		SetPedComponentVariation(PlayerPedId(),8,10,0,2)
		SetPedComponentVariation(PlayerPedId(),6,0,0,1)
		SetPedComponentVariation(PlayerPedId(),11,23,0,1)
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),4,4,0,1)
		SetPedComponentVariation(PlayerPedId(),8,15,0,1)
		SetPedComponentVariation(PlayerPedId(),6,1,3,1)
		SetPedComponentVariation(PlayerPedId(),11,0,0,1)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),0,-1,0,2)
