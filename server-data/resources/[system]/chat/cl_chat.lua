...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/192', 'Mandar mensagem para o Hospital.', {{ name="TEXTO"}})
	TriggerEvent('chat:addSuggestion', '/190', 'Mandar mensagem para o Departamento Policial.', {{ name="TEXTO"}})
	...
	TriggerEvent('chat:addSuggestion', '/call', 'Executar um chamado.', {{ name="NÚMERO",help="ADM."}})
	...
	TriggerEvent('chat:addSuggestion', '/mala', 'Para abrir/fechar o porta malas.')
	...
	TriggerEvent('chat:addSuggestion', '/colete', 'Colocar colete (apenas visual).', {{ name="PASSAPORTE"}})
	...
	TriggerEvent('chat:addSuggestion', '/paypal trans', 'Para fazer uma transferência via PayPal.', {{ name="PASSAPORTE"},{ name="VALOR"}})
	TriggerEvent('chat:addSuggestion', '/paypal sacar', 'Para sacar seu dinheiro PayPal para sua conta bancária.', {{ name="VALOR"}})
