...
oC = Tunnel.getInterface("cv_craft")
-------------------------------------------------------------------------------------------------
--[ LOCAL ]--------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
local prodMachine = {
	--{ ['x'] = -101.75, ['y'] = 1053.75, ['z'] = 226.82 }
	{ ['x'] = 772.07, ['y'] = -260.09, ['z'] = 68.95 } -- 772.07,-260.09,68.95
}
-------------------------------------------------------------------------------------------------
--[ MENU ]---------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "produzir-pino" then
		TriggerServerEvent("produzir-muni-cv","pino")
		
	elseif data == "produzir-componentes" then
		TriggerServerEvent("produzir-muni-cv","componentes")
...
RegisterNetEvent("fechar-nui-cv")
AddEventHandler("fechar-nui-cv", function()
	ToggleActionMenu()
	onmenu = false

	local ped = PlayerPedId()
	local x,y,z = table.unpack(GetEntityCoords(ped))
	local bowz,cdz = GetGroundZFor_3dCoord(772.07,-260.09,68.95)
	local distance = GetDistanceBetweenCoords(772.07,-260.09,68.95, cdz, x, y, z, true)
