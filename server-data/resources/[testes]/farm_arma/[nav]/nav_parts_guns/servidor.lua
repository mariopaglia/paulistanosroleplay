...
function Perm.checkPermissao()
    local source = source
    local user_id = vRP.getUserId(source)
    if vRP.hasPermission(user_id,"oc-guns01.permissao") or vRP.hasPermission(user_id,"oc-guns01.permissao") or vRP.hasPermission(user_id,"oc-guns02.permissao") or vRP.hasPermission(user_id,"oc-guns02.permissao")then
        return true
    end
end