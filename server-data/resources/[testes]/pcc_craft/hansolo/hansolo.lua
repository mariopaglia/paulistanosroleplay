...
oC = Tunnel.getInterface("pcc_craft")
-------------------------------------------------------------------------------------------------
--[ LOCAL ]--------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
local prodMachine = {
	--{ ['x'] = -101.75, ['y'] = 1053.75, ['z'] = 226.82 }
	{ ['x'] = 2046.87, ['y'] = -146.88, ['z'] = 270.99 } -- 2046.87,-146.88,270.99
}
-------------------------------------------------------------------------------------------------
--[ MENU ]---------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "produzir-embalagem" then
		TriggerServerEvent("produzir-muni-pcc","embalagem")
		
	elseif data == "produzir-adubo" then
		TriggerServerEvent("produzir-muni-pcc","adubo")
...
RegisterNetEvent("fechar-nui-pcc")
AddEventHandler("fechar-nui-pcc", function()
	ToggleActionMenu()
	onmenu = false

	local ped = PlayerPedId()
	local x,y,z = table.unpack(GetEntityCoords(ped))
	local bowz,cdz = GetGroundZFor_3dCoord(2046.87,-146.88,270.99)
	local distance = GetDistanceBetweenCoords(2046.87,-146.88, cdz, x, y, z, true)
