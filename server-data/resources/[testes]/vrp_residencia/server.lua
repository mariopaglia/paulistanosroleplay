            ...
            for k, v in pairs(policia) do
                ...
                if player then
                    async(function()
                        ...
                        TriggerClientEvent("Notify", player, "policia", "O alarme da residência <b>" .. tostring(house) .. "</b> disparou, verifique o ocorrido.", 20000)
                        TriggerClientEvent('chatMessage', player, "CENTRAL:",{65,130,255}, "O alarme da residência ^1" .. tostring(house) .. "^0 disparou, verifique o ocorrido.")
