...
AddEventHandler('LOG:ARMAS654654684', function()
    ...
    if user_id~=nil then
    	...
    	PerformHttpRequest(webhookspawnarma, function(err, text, headers) end, 'POST', json.encode({content = "[BANIDO] SPAWN DE ARMAS "..user_id}), { ['Content-Type'] = 'application/json' })
    end
end)
