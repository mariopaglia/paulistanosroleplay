...
Citizen.CreateThread(function()
	while true do
		...
		if checkDistance() then
			...
			DrawText3D(-551.03857421875,-192.28303527832,38.223083496094, "Mudar Nome - R$ 100.000", 2.0, 7, 100)
			DrawText3D(-551.03857421875,-192.28303527832,38.223083496094-0.2, "/identidade [nome] [sobrenome] [idade]", 2.0, 1, 100)
			DrawText3D(-551.03857421875,-192.28303527832,38.223083496094-0.4, "Resetar Aparência - R$ 200.000", 2.0, 7, 100)
