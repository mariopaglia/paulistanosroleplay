...
Config.Veiculos = {
    ...
    },
    {
        ...
        veiculos = {
            {title = "Honda Africa Twin", model = "africat", mala = 100, preco = 1, estoque = 0},
            {title = "Corvette C7", model = "c7", mala = 100, preco = 1, estoque = 0},
            {title = "Nissan GT-R 35 Japan", model = "r35", mala = 100, preco = 1, estoque = 0},
            {title = "VW Golf R", model = "golf75r", mala = 100, preco = 1, estoque = 0},
            {title = "Porsche 718 Boxster", model = "718b", mala = 100, preco = 1, estoque = 0},
            {title = "Audi R8 2020", model = "r820", mala = 100, preco = 1, estoque = 0},
            {title = "Lamborghini Urus", model = "urus2018", mala = 100, preco = 1, estoque = 0},
            {title = "Nissan GT-R 35 Libert Walk", model = "lwgtr", mala = 100, preco = 1, estoque = 0},
            {title = "BMW M4 Libert Walk", model = "m4lb", mala = 100, preco = 1, estoque = 0},
            {title = "Lamborghini Huracan", model = "lamborghinihuracan", mala = 100, preco = 1, estoque = 0},
            {title = "Nissan GTR Nismo", model = "nissangtrnismo", mala = 100, preco = 1, estoque = 0},
            {title = "Nissan Skyline R34", model = "nissanskyliner34", mala = 100, preco = 1, estoque = 0},
            {title = "Nissan Titan", model = "nissantitan17", mala = 100, preco = 1, estoque = 0},
            {title = "Porsche 992", model = "porsche992", mala = 100, preco = 1, estoque = 0},
            {title = "Lamborghini Aventador", model = "lp700r", mala = 100, preco = 1, estoque = 0},
            {title = "Pagani Zonda", model = "bc", mala = 100, preco = 1, estoque = 0},
            {title = "Lancer Evolution 10", model = "lancerevolutionx", mala = 100, preco = 1, estoque = 0},
            {title = "Yamaha R1", model = "r1", mala = 100, preco = 1, estoque = 0},
            {title = "BMW S1000", model = "bmws", mala = 100, preco = 1, estoque = 0},
            {title = "BMW R1250", model = "r1250", mala = 100, preco = 1, estoque = 0},
            {title = "Ferrari Italia 478", model = "ferrariitalia", mala = 100, preco = 1, estoque = 0},
