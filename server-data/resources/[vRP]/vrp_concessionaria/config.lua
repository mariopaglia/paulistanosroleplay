...
Config.Veiculos = {
    {
        ...
        veiculos = {
            ...
            --
            {title = "revolter", model = "revolter", mala = 40, preco = 92000, estoque = 50},
    ...
    },
    {
        ...
        veiculos = {
            {title = "Dodge Charger", model = "defiant", mala = 20, preco = 650000, estoque = 5},
            {title = "Plymouth GTX", model = "71gtx", mala = 20, preco = 750000, estoque = 5},
            {title = "Mustang Mach 1", model = "mustangmach1", mala = 0, preco = 850000, estoque = 5},
            {title = "Porsche 930", model = "porsche930", mala = 10, preco = 950000, estoque = 5},
            --  
            {title = "Nissan 180SX", model = "180sx", mala = 20, preco = 1000000, estoque = 5},
            {title = "Mitsubishi Eclipse", model = "eclipse", mala = 0, preco = 1150000, estoque = 5},
            {title = "Civic Type R", model = "hondafk8", mala = 30, preco = 1200000, estoque = 5},
            {title = "Mazda RX7", model = "mazdarx7", mala = 10, preco = 1300000, estoque = 5},
            --
            {title = "Lancer Evolution 9", model = "lancerevolution9", mala = 20, preco = 1400000, estoque = 5},
            {title = "Toyota Supra", model = "toyotasupra", mala = 0, preco = 1500000, estoque = 5},
            {title = "Nissan 370Z", model = "nissan370z", mala = 0, preco = 1600000, estoque = 5},
            {title = "Nissan GTR", model = "nissangtr", mala = 10, preco = 1700000, estoque = 5},
            --
            {title = "focus RS", model = "focusrs", mala = 10, preco = 1800000, estoque = 5},
            {title = "Tesla Prior", model = "teslaprior", mala = 30, preco = 1900000, estoque = 5},
            {title = "Ford Raptor", model = "raptor2017", mala = 80, preco = 2000000, estoque = 5},
            {title = "amarok", model = "amarok", mala = 80, preco = 2100000, estoque = 5},
            --  
            {title = "Aston Martin DB11", model = "db11", mala = 10, preco = 2150000, estoque = 5},
            {title = "Mercedes AMG C63-S", model = "rmodamgc63", mala = 20, preco = 2250000, estoque = 5},
            {title = "Camaro ZL1", model = "2018zl1", mala = 10, preco = 2300000, estoque = 5},
            {title = "Ford Mustang GT", model = "fordmustang", mala = 10, preco = 2300000, estoque = 5},
            --    
            {title = "Mercedes AMG A45", model = "mercedesa45", mala = 20, preco = 2350000, estoque = 5},
            {title = "Porsche Panamera", model = "palameila", mala = 30, preco = 2450000, estoque = 5},
            {title = "Audi RS7", model = "audirs7", mala = 40, preco = 2550000, estoque = 5},
            {title = "Audi RS6", model = "audirs6", mala = 40, preco = 2550000, estoque = 5},
            --
            {title = "Jaguar F-type", model = "19ftype", mala = 20, preco = 2650000, estoque = 5},
            {title = "Ford GT", model = "gt17", mala = 0, preco = 2750000, estoque = 5},
            {title = "Porsche 911R", model = "911r", mala = 0, preco = 2950000, estoque = 5},
            {title = "Ferrari California", model = "fc15", mala = 20, preco = 3000000, estoque = 5},
        },
    },
    {
    ...
    },
    {
        ...
        veiculos = {
            ...
            {title = "comet4", model = "comet4", mala = 20, preco = 320000, estoque = 10}, -- Novo | Adicionar na Base (0x5D1903F9) | Alterar bau pra 20 kg
            --
    ...
    },
    {
        ...
        veiculos = {
            ...
            {title = "bros60", model = "bros60", mala = 0, preco = 150000, estoque = 20},
            --
            {title = "zombiea", model = "zombiea", mala = 0, preco = 200000, estoque = 20},
            {title = "gargoyle", model = "gargoyle", mala = 10, preco = 200000, estoque = 20},
            {title = "daemon", model = "daemon", mala = 10, preco = 200000, estoque = 20},
            {title = "chimera", model = "chimera", mala = 10, preco = 200000, estoque = 20},
            --
            {title = "manchez", model = "manchez", mala = 0, preco = 200000, estoque = 20},
            {title = "enduro", model = "enduro", mala = 0, preco = 200000, estoque = 20},
            {title = "double", model = "double", mala = 10, preco = 250000, estoque = 20},
            {title = "carbonrs", model = "carbonrs", mala = 10, preco = 250000, estoque = 20},
            --
            {title = "sanchez2", model = "sanchez2", mala = 0, preco = 250000, estoque = 20},
            {title = "sanchez", model = "sanchez", mala = 05, preco = 250000, estoque = 20},
            {title = "bf400", model = "bf400", mala = 05, preco = 300000, estoque = 20},
            {title = "bati2", model = "bati2", mala = 10, preco = 320000, estoque = 20},
            --
            {title = "bati", model = "bati", mala = 10, preco = 320000, estoque = 20},
            {title = "akuma", model = "akuma", mala = 10, preco = 330000, estoque = 20},
            {title = "hakuchou", model = "hakuchou", mala = 10, preco = 340000, estoque = 20},
            {title = "hakuchou2", model = "hakuchou2", mala = 05, preco = 350000, estoque = 20},
            --
            {title = "xt66", model = "xt66", mala = 0, preco = 500000, estoque = 5},
            {title = "hornet", model = "hornet", mala = 0, preco = 1000000, estoque = 5},
            --
            {title = "cbrr", model = "cbrr", mala = 0, preco = 1150000, estoque = 5},
            {title = "r6", model = "r6", mala = 0, preco = 1250000, estoque = 5},
            {title = "z1000", model = "z1000", mala = 0, preco = 1300000, estoque = 5},
            {title = "dm1200", model = "dm1200", mala = 0, preco = 1500000, estoque = 5},
        },
    },
}
