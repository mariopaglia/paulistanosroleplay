...
Config.Veiculos = {
    ...
    },
    {
        ...
        veiculos = {
            {title = "lamborghinihuracan", model = "lamborghinihuracan", mala = 0, preco = 1000, estoque = 0},
            {title = "corvette", model = "corvette", mala = 0, preco = 1000, estoque = 0},
            {title = "nissangtrnismo", model = "nissangtrnismo", mala = 0, preco = 1000, estoque = 0},
            {title = "nissanskyliner34", model = "nissanskyliner34", mala = 0, preco = 1000, estoque = 0},
            {title = "nissantitan17", model = "nissantitan17", mala = 0, preco = 1000, estoque = 0},
            {title = "porsche992", model = "porsche992", mala = 0, preco = 1000, estoque = 0},
            {title = "msohs", model = "msohs", mala = 0, preco = 1000, estoque = 0},
            {title = "amggtr", model = "amggtr", mala = 0, preco = 1000, estoque = 0},
            {title = "fxxkevo", model = "fxxkevo", mala = 0, preco = 1000, estoque = 0},
            {title = "aperta", model = "aperta", mala = 0, preco = 1000, estoque = 0},
            {title = "lp700r", model = "lp700r", mala = 0, preco = 1000, estoque = 0},
            {title = "i8", model = "i8", mala = 0, preco = 1000, estoque = 0},
            {title = "bc", model = "bc", mala = 0, preco = 1000, estoque = 0},
            {title = "slsamg", model = "slsamg", mala = 0, preco = 1000, estoque = 0},
            {title = "veneno", model = "veneno", mala = 0, preco = 1000, estoque = 0},
            {title = "bugatti", model = "bugatti", mala = 0, preco = 1000, estoque = 0},
            {title = "lancerevolutionx", model = "lancerevolutionx", mala = 0, preco = 1000, estoque = 0},
            {title = "r1", model = "r1", mala = 0, preco = 1000, estoque = 0},
            {title = "bmws", model = "bmws", mala = 0, preco = 1000, estoque = 0},
            {title = "r1250", model = "r1250", mala = 0, preco = 1000, estoque = 0},
            {title = "ferrariitalia", model = "ferrariitalia", mala = 0, preco = 1000, estoque = 0},
            {title = "BMW i8 Coupe", model = "rmodi8ks", mala = 0, preco = 1000, estoque = 0},
            {title = "BMW EVO i8 Dark", model = "rmoddarki8", mala = 0, preco = 1000, estoque = 0},
            {title = "Mercedes-Benz G65", model = "rmodg65", mala = 0, preco = 1000, estoque = 0},
            {title = "Lamborghini LP670", model = "rmodlp670", mala = 0, preco = 1000, estoque = 0},
            {title = "Audi RS6 C8", model = "rmodrs6", mala = 0, preco = 1000, estoque = 0},
            {title = "Lamborghini Sian", model = "rmodsianr", mala = 0, preco = 1000, estoque = 0},
            {title = "Toyota GR Supra", model = "rmodsuprapandem", mala = 0, preco = 1000, estoque = 0},
            {title = "Mercedes-AMG C63", model = "rmodc63amg", mala = 0, preco = 1000, estoque = 0},
            {title = "Koenigsegg Jesko", model = "rmodjesko", mala = 0, preco = 1000, estoque = 0},
            {title = "Mercedes-AMG GT 63S", model = "rmodgt63", mala = 0, preco = 1000, estoque = 0},
            {title = "BMW M8 Competition", model = "rmodbmwm8", mala = 0, preco = 1000, estoque = 0},
            {title = "Bugatti La Voiture", model = "rmodbugatti", mala = 0, preco = 1000, estoque = 0},
            {title = "Bugatti Chiron Super", model = "rmodchiron300", mala = 0, preco = 1000, estoque = 0},
