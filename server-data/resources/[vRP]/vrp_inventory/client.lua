...
-- -----------------------------------------------------------------------------------------------------------------------------------------
-- -- CRIAR BLIP DE DESMANCHE
-- -----------------------------------------------------------------------------------------------------------------------------------------
-- RegisterNetEvent('rotadesmanche')
-- AddEventHandler('rotadesmanche',function()
--     local locs = {
-- 		[1] = { ['x'] = 2140.73, ['y'] = 4782.53, ['z'] = 40.98 },
-- 		[2] = { ['x'] = -1173.9, ['y'] = -2062.62, ['z'] = 14.35 },
-- 		[3] = { ['x'] = -441.55, ['y'] = 6342.22, ['z'] = 12.73 },
-- 		[4] = { ['x'] = 1540.21, ['y'] = 6336.91, ['z'] = 24.08 },
-- 		[5] = { ['x'] = 870.75, ['y'] = 2871.6, ['z'] = 56.91 },
-- 		[6] = { ['x'] = 132.41, ['y'] = -3210.44, ['z'] = 5.86 },
-- 	}
...
-- -----------------------------------------------------------------------------------------------------------------------------------------
-- -- CANCELAR ROTA DO DESMANCHE
-- -----------------------------------------------------------------------------------------------------------------------------------------
-- RegisterKeyMapping('emp:rotadesmanche_fenix', 'Cancelar Rota Desmanche', 'keyboard', 'F7')

-- RegisterCommand('emp:rotadesmanche_fenix', function()
-- 	if servico then
-- 			servico = false
-- 			RemoveBlip(blips)
-- 			vRP.removeUserGroup(user_id, "Desmanche")
-- 			TriggerEvent("Notify","aviso","Você cancelou a rota do desmanche.")
-- 	end
-- end, false)
...
-- 	AddTextComponentString("Rota de Desmanche")
