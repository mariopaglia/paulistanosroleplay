...
vRPNserver = Tunnel.getInterface("vrp_inventorynovo")
vRPNclient = {}
Tunnel.bindInterface("vrp_inventorynovo",vRPNclient)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIÁVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local invOpen = false
...
-- ABRIR INVENTARIO
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping('vrp_inventorynovo:abririnv_fenix', 'Abrir Inventário', 'keyboard', 'OEM_3')

RegisterCommand('vrp_inventorynovo:abririnv_fenix', function()
