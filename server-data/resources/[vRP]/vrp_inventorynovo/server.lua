...
vRPNclient = Tunnel.getInterface("vrp_inventorynovo","vrp_inventorynovo")
			...
			elseif itemName == "agua" then
				if vRP.tryGetInventoryItem(user_id,"agua",1) then
					...
					SetTimeout(10000,function()
						...
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Água</b>",8000)
					end)
				end
			elseif itemName == "cafe" then
				if vRP.tryGetInventoryItem(user_id,"cafe",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,0)
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Cafe</b>",8000)
					end)
				end
			elseif itemName == "cappuccino" then
				if vRP.tryGetInventoryItem(user_id,"cappuccino",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,0)
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Cappuccino</b>",8000)
					end)
				end
			elseif itemName == "cocacola" then
				if vRP.tryGetInventoryItem(user_id,"cocacola",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,0)
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Coca Cola</b>",8000)
					end)
				end
			elseif itemName == "sprite" then
				if vRP.tryGetInventoryItem(user_id,"sprite",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,0)
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Sprite</b>",8000)
					end)
				end
			elseif itemName == "suco" then
				if vRP.tryGetInventoryItem(user_id,"suco",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,0)
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Suco</b>",8000)
					end)
				end
			elseif itemName == "leite" then
				if vRP.tryGetInventoryItem(user_id,"leite",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,0)
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Leite</b>",8000)
					end)
				end
			elseif itemName == "mamadeira" then
				if vRP.tryGetInventoryItem(user_id,"mamadeira",1) then
					...
					SetTimeout(10000,function()
						...
						vRPclient._DeletarObjeto(source)
						TriggerClientEvent("Notify",source,"sucesso","Você tomou <b>Mamadeira</b>",8000)
					end)
				end
			elseif itemName == "hamburguer" then
				...
				if vRP.tryGetInventoryItem(user_id,"hamburguer",1) then
					...
					SetTimeout(10000,function()
						...
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Hamburguer</b>")
					end)
			...
			elseif itemName == "sanduiche" then
				...
				if vRP.tryGetInventoryItem(user_id,"sanduiche",1) then
					...
					SetTimeout(10000,function()
						...
						vRPclient._DeletarObjeto(src)
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Sanduiche</b>")
					end)
			...
			elseif itemName == "frangofrito" then
				...
				if vRP.tryGetInventoryItem(user_id,"frangofrito",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,-55)
						vRPclient._DeletarObjeto(src)
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Frango Frito</b>")
					end)
			...
			elseif itemName == "batatafrita" then
				...
				if vRP.tryGetInventoryItem(user_id,"batatafrita",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,-55)
						vRPclient._DeletarObjeto(src)
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Batata Frita</b>")
					end)
			...
			elseif itemName == "cachorroquente" then
				...
				if vRP.tryGetInventoryItem(user_id,"cachorroquente",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,-55)
						vRPclient._DeletarObjeto(src)
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Cachorro Quente</b>")
					end)
			...
			elseif itemName == "pizza" then
				...
				if vRP.tryGetInventoryItem(user_id,"pizza",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,-35)
						vRPclient._DeletarObjeto(src)
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Pizza</b>")
					end)
			...
			elseif itemName == "rosquinha" then
				...
				if vRP.tryGetInventoryItem(user_id,"rosquinha",1) then
					...
					SetTimeout(10000,function()
						...
						vRP.varyHunger(user_id,-35)
						vRPclient._DeletarObjeto(src)
						TriggerClientEvent("Notify",source,"sucesso","Você comeu <b>Rosquinha</b>")
					end)
