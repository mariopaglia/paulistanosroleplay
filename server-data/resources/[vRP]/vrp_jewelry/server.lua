	...
	for l,w in pairs(policia) do
		...
		if player then
			async(function()
				...
				TriggerClientEvent("Notify", player, "policia", "O roubo começou na <b>Joalheria</b>, dirija-se até o local e intercepte o assaltante.", 20000)
				TriggerClientEvent('chatMessage',player,"CENTRAL:",{65,130,255},"O roubo começou na ^1Joalheria^0, dirija-se até o local e intercepte o assaltante.")
