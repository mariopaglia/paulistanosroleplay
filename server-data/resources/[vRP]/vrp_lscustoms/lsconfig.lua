...
LSC_Config.prices = {
	...
	mods = {
		...
		[16] = {
			{ name = "Resistência 20%", modtype = 16, mod = 0, price = 5000 },
			{ name = "Resistência 40%", modtype = 16, mod = 1, price = 10000 },
			{ name = "Resistência 60%", modtype = 16, mod = 2, price = 15000 },
			{ name = "Resistência 80%", modtype = 16, mod = 3, price = 20000 },
			{ name = "Resistência 100%", modtype = 16, mod = 4, price = 30000 }
		},
		[15] = {
			{ name = "Lowered Suspension", mod = 0, price = 10000 },
			{ name = "Street Suspension", mod = 1, price = 15000 },
		...
		[13] = {
			...
			{ name = "Sports Transmission", mod = 1, price = 17000 },
			{ name = "Race Transmission", mod = 2, price = 20000 }
		},
		[12] = {
			{ name = "Street Brakes", mod = 0, price = 15000 },
			{ name = "Sport Brakes", mod = 1, price = 17000 },
			{ name = "Race Brakes", mod = 2, price = 20000 }
		},
		[11] = {
			{ name = "Street Engine", mod = 0, price = 15000 },
			{ name = "Sports Engine", mod = 1, price = 20000 },
			{ name = "Race Engine", mod = 2, price = 25000 },
			{ name = "Top Engine", mod = 3, price = 30000 }
		},
		[10] = {
			startprice = 2700,
			increaseby = 0
